...
public:
	...
	{
		return static_cast<float>(a*2.0f*M_PI/360.f);
	}
    ...
    inline void translate(const DIR where, const float c=1.f)
	{
	...
	float getRotUp() const { return rotUp; }
	float getRotLeft() const { return rotLeft; }
	math::Vec3f getPos() const { return pos; }
//	Camera_FlyTrackball getFlyOrTrackball() const { return flyOrTrackball; }
protected:
	math::Vec3f pos;
    float rotLeft;
